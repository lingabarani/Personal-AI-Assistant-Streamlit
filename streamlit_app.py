...
st.set_page_config(
    page_title="Free Personal AI Assistant", layout="wide", initial_sidebar_state="expanded"
)
...
with st.sidebar:
    st.title('Free Personal Chat App')
...
html_chat = """
<center>
    <h6>✨ This Personal AI Assistant Project was developed and customized by <b>Lingabarani</b> ✨</h6>
    <br>
    <p>📧 Contact: <a href="lingabaraniak@gmail.com">lingabaraniak@gmail.com</a></p>
    <p>🌐 Portfolio: <a href="https://github.com/lingabarani" target="_blank">GitHub</a> | 
    <a href="https://www.linkedin.com/in/lingabarani/" target="_blank">LinkedIn</a></p>
    <br>
    <p>🚀 Features: Conversational AI • Document Q&A • YouTube Transcript Summarizer • Plugin-ready</p>
    <p>💡 Developed with Streamlit, HuggingFace, LangChain, and Python</p>
</center>
"""

st.markdown(html_chat, unsafe_allow_html=True)
st.write("Designed & Built by Lingabarani | AI & Data Science Enthusiast")
...
with st.sidebar:
    st.markdown(
        ...
        <div class="sidebar-footer">
            <hr>
            © 2025 <b>Lingabarani</b><br>
            All Rights Reserved.<br><br>
            📧 <a href="mailto:lingabaraniak@gmail.com">lingabaraniak@gmail.com</a><br>
            🌐 <a href="https://github.com/lingabarani" target="_blank">GitHub</a><br>
            🔗 <a href="https://www.linkedin.com/in/lingabarani/" target="_blank">LinkedIn</a>
        </div>
        """,
